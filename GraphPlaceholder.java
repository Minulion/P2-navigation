...
public class GraphPlaceholder implements GraphADT<String, Double> {
   ...
   public double shortestPathCost(String start, String end) {
      if (start.equals("Union South") && end.equals("Union South")) {
         return 100.0;
      } else if (start.equals("Union South") && end.equals("Computer Sciences and Statistics")) {
         return 200.0;
      } else if (start.equals("Union South") && end.equals("Atmospheric, Oceanic and Space Sciences")) {
         return 300.0;
      } else {
         throw new NoSuchElementException();
      }
